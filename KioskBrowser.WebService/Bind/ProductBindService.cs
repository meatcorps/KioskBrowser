...
public class ProductBindService: IDisposable
{
    ...
    public ProductBindService(IHubContext<DataHub> dataHubContext, DataCollectionService dataCollectionService)
    {
    ...
    private void OnChangeList(ProductData[] data)
    {
        _dataHubContext.Clients.All.SendAsync("AllProducts", data);
    }
